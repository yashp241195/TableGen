   var row_count_bm = row_count_bs = row_count_st = row_count_hb = row_count_ws = 1;
    ...
    var row_max_count_st = scientific_test.length;
    var row_max_count_hb = health_background.length;
    var row_max_count_ws = workout_schedule.length;
    ...
    function insert_row(table_name){
        ...
        switch(table_name){
            ...
            case "scientific_test":
                row_count = row_count_st;
                row_max_count = row_max_count_st;
                break;

            case "workout_schedule":
                row_count = row_count_ws;
                row_max_count = row_max_count_ws;
                break;
        }
